...
__kernel void k_lj96_dsf(const __global numtyp4 *restrict x_,
  ...
  if (ii<inum) {
    ...
    for ( ; nbor<nbor_end; nbor+=n_stride) {
      ...
      if (rsq<lj1[mtype].w) {
        ...
        numtyp forcecoul, force_lj, force, r6inv, r3inv;
        r = ucl_sqrt(rsq);
...
__kernel void k_lj96_dsf_fast(const __global numtyp4 *restrict x_,
