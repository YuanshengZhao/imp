...
class NMCoulLong : public BaseCharge<numtyp, acctyp> {
 public:
  ...
  int init(const int ntypes, double **host_cutsq, double **host_e0nm,
  ...
  void reinit(const int ntypes, double **host_cutsq, double **host_e0nm,
                  double **host_fnm, double **host_nn, double **host_mm,
  ...
  /// lj1.x = e0nm, lj1.y = fnm, lj1.z = cutsq, lj1.w = cutsq_vdw
