...
PairXNDAFRMDGPU::PairXNDAFRMDGPU(LAMMPS *lmp) : PairXNDAFGPU(lmp) {}

/* ---------------------------------------------------------------------- */
// file format : q sqx wtx kx mx sqn wtn kn mn
void PairXNDAFRMDGPU::read_file(char *file)
{
...
void PairXNDAFRMDGPU::generateForceTable()
{  
  #ifdef XNDAF_DEBUG
