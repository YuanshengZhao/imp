...
PairLJ96CutCoulDSF::PairLJ96CutCoulDSF(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
}
...
PairLJ96CutCoulDSF::~PairLJ96CutCoulDSF()
{
  if (copymode) return;
...
void PairLJ96CutCoulDSF::compute(int eflag, int vflag)
{
...
void PairLJ96CutCoulDSF::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJ96CutCoulDSF::settings(int narg, char **arg)
{
...
void PairLJ96CutCoulDSF::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
double PairLJ96CutCoulDSF::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJ96CutCoulDSF::write_restart(FILE *fp)
{
...
void PairLJ96CutCoulDSF::read_restart(FILE *fp)
{
...
void PairLJ96CutCoulDSF::write_restart_settings(FILE *fp)
{
...
void PairLJ96CutCoulDSF::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJ96CutCoulDSF::single(int i, int j, int itype, int jtype, double rsq,
                                double factor_coul, double factor_lj,
                                double &fforce)
{
  double r2inv,r3inv,r6inv,r,erfcc,erfcd,prefactor;
...
void *PairLJ96CutCoulDSF::extract(const char *str, int &dim)
{
